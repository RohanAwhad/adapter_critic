...
from experiments.v6.upstream_resolution import (
    ...
    return AppConfig.model_validate(
        {
            "served_models": {
                ...
                "served-adapter": {
                    "mode": "adapter",
                    "api": {"model": "gpt-oss-120b", "base_url": api_base_url},
                    "adapter": {"model": "qwen3-30b-a3b-thinking", "base_url": adapter_base_url},
                },
                "served-critic": {
                    "mode": "critic",
                    "api": {"model": "gpt-oss-120b", "base_url": api_base_url},
                    "critic": {"model": "qwen3-30b-a3b-thinking", "base_url": adapter_base_url},
